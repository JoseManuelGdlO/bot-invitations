...
function defaultAI(assistant: string, hosts: string): AIConfig {
  return {
    ...
    rules: [
      ...
      "Si es FAQ, responde con los datos del evento y las preguntas frecuentes; si no hay dato, no inventes y ofrece pasar al equipo.",
      "Si confirma o decline con claridad, usa actualizar_confirmacion y escribe en reply un mensaje genérico de confirmación de asistencia.",
