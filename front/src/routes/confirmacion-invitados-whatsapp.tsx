      ...
      related={[
        {
          ...
          label: "Software para wedding planners",
        },
        { href: "/software-rsvp-bodas", label: "Software RSVP para bodas" },
        {
          href: "/blog/rsvp-whatsapp-vs-excel",
          label: "RSVP por WhatsApp vs Excel",
        },
      ]}
    >
      <SeoSection title="Por qué WhatsApp gana al formulario">
        <p>
          Un link de RSVP se pierde entre stories y correos. Un WhatsApp se
          abre. En bodas familiares en México, la tasa de respuesta sube cuando
          no pides otra app ni una contraseña.
        </p>
        <p>
          El canal, eso sí, no basta. Si confirmas desde tu celular personal, el
          estudio se vuelve un call center. Hace falta un envío con guion,
          recordatorios y un tablero que no sea tu galería de capturas.
        </p>
      </SeoSection>
      <SeoSection title="Qué pregunta el primer mensaje">
        <p>
          Quién escribe, fecha del evento, lugares asignados y qué contestar:
          asistencia y número de personas. Menú, canción o alergias pueden ir
          después, cuando ya hay un sí. Un mensaje largo en el primer toque se
          ignora.
        </p>
        <p>
          Alanna lanza ese primer contacto a partir de tu Excel o CSV. El
          asistente sigue la conversación y deja cada invitación en un estado
          claro para que banquetes reciba un número, no una estima.
        </p>
      </SeoSection>
      <SeoSection title="Seguimiento sin perseguir a mano">
        <p>
          Tres oleadas suelen bastar: envío, recordatorio a pendientes y aviso
          de corte. El resto son excepciones que autoriza el cliente. El detalle
          de tono y fechas está en{" "}
          <a
            href="/blog/dejar-de-perseguir-confirmaciones"
