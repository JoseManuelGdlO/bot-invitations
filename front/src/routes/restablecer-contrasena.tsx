...
export const Route = createFileRoute("/restablecer-contrasena")({
  ...
  head: () =>
    pageHead({
      ...
      description: "Define una nueva contraseña para tu cuenta de Alanna Confirmaciones.",
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-16">
      <div className="w-full max-w-sm">
        ...
        <h1 className="font-display text-4xl leading-tight">Nueva contraseña</h1>
        <p className="mt-2 text-sm text-muted-foreground">Elige una contraseña de al menos 6 caracteres.</p>
