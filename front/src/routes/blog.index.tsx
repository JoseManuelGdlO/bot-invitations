  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-5 py-12 lg:py-16">
      ...
      <h1 className="mt-3 font-display text-4xl leading-[1.1] sm:text-5xl">
        Guías para confirmar invitados
      </h1>
      <p className="mt-5 text-base leading-relaxed text-muted-foreground">
        Listas, WhatsApp y cierre de RSVP para wedding planners. Sin recetas
        vacías: el proceso que usa un estudio cuando la boda ya no cabe en un
        chat personal.
      </p>
