...
export const Route = createFileRoute("/recuperar-contrasena")({
  head: () =>
    pageHead({
      ...
      description: "Solicita un enlace para restablecer el acceso a tu cuenta de Alanna Confirmaciones.",
...
function Recuperar() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(err instanceof ApiError ? err.message : "No se pudo enviar el enlace");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-16">
      <div className="w-full max-w-sm">
        ...
        <h1 className="font-display text-4xl leading-tight">Recupera tu acceso</h1>
